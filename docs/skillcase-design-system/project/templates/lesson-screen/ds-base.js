...
(() => {
  const base = '../..';
  for (const p of ["tokens/fonts.css","tokens/fig-tokens.css","tokens/fig-typography.css","tokens/brand.css","tokens/app.css","tokens/semantic.css","components/data-display/fig-assets.css","styles.css"]) {
